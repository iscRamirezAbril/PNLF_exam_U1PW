"""
Django settings for examU1 project.
...
INSTALLED_APPS = [
    ...
    'PNLF_CRUD', # Agregamos la aplicación PNLF_CRUD
...
WSGI_APPLICATION = 'examU1.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'HOST': 'PW.AXOLOTLTEAM.COM' + config('SQL_INSTANCE'), # Nombre del servidor de la base de datos y la instancia
